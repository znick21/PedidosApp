...
namespace CapaNegocio
{
    public class NVenta
    {
        ...
        //Método BuscarFecha que llama al método BuscarFecha de la clase DVenta de la CapaDatos
        public static DataTable BuscarFechas(string textobuscar, string textobuscar2)
        {
            DVenta Obj = new DVenta();
            return Obj.BuscarFechas(textobuscar, textobuscar2);
        }
        //Metodo Mostrardetalle que llama al método Mostrardetalle de la clase DVenta de la CapaDatos
