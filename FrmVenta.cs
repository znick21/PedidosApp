...
namespace PedidosApp1
{
    public partial class FrmVenta : Form
    {
        ...
        //Idtrabajdor viene del formulario Login solo para probar asignamos 1
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult Opcion;
                Opcion = MessageBox.Show("Realmente Desea Eliminar los Registros", "Pedidos App", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        {
            Reportes.FrmFacturaRollo frm = new Reportes.FrmFacturaRollo();
            frm.Idventa = Convert.ToInt32(this.dataListado.CurrentRow.Cells["idventa"].Value);
