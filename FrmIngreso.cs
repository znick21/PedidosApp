...
namespace PedidosApp1
{
    public partial class FrmIngreso : Form
    {
        ...
        public FrmIngreso()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtSerie, "Ingrese numero de serie del comprobante");
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult Opcion;
                Opcion = MessageBox.Show("Realmente Desea Anular los Registros", "Sistema de Ventas", 
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataListado.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            if (Rpta.Equals("OK"))
                            {
                                this.MensajeOk("Se Anuló Correctamente los Ingreso");
                            }
                            else
                            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (rpta.Equals("OK"))
                    {
                        if (this.IsNuevo)
                        {
                            this.MensajeOk("Se Insertó de forma correcta los registros");
                        }
                    }
                    else
                    {
